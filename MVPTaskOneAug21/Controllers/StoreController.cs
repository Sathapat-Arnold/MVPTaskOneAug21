...
namespace MVPTaskOneAug21.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StoreController : ControllerBase
    {
        private readonly MVPTaskOneDBContext _context;

        public StoreController(MVPTaskOneDBContext context)
        {
            _context = context;
        }
